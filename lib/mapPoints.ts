...
export const MAP_POINT_TYPES: Record<MapPointTypeKey, MapPointTypeMeta> = {
  quest: { label: "Úkol", color: "#7fb3ff", emoji: "❓", adminOnly: true },
  treasure: { label: "Poklad", color: "#e9c46a", emoji: "⭐", adminOnly: true },
  story_location: {
...
/** Typy, které na mapě zakládá admin. */
export const ADMIN_POINT_TYPES = (
  Object.keys(MAP_POINT_TYPES) as MapPointTypeKey[]
).filter((k) => MAP_POINT_TYPES[k].adminOnly);
